...
- Harness/docs: local `ckp-test` and `clawkernel-docs` were updated to the reconciled L3 matrix; `clawkernel` CI now pins the spec-aligned harness commit `9b91298`.
