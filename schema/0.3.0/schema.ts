/**
 * Claw Kernel Protocol (CKP) v0.3.0 — TypeScript Type Definitions
 *
...
export interface SkillSpec {
  ...
  /** Optional reference to a declared WorldModel. */
  world_model_ref?: string;
...
export type WorldModel = PrimitiveEnvelope<"WorldModel", WorldModelSpec>;
...
// ---------------------------------------------------------------------------
// 5.11 Telemetry (OPTIONAL at all conformance levels)
// ---------------------------------------------------------------------------
...
export interface TelemetryEvents {
  tool_calls?: boolean;
  memory_ops?: boolean;
  world_model_ops?: boolean;
  planning_ops?: boolean;
  swarm_ops?: boolean;
  lifecycle?: boolean;
  errors?: boolean;
}
...
export interface TelemetryMetrics {
  ...
  prediction_error?: boolean;
  retrieval_hit_rate?: boolean;
  plan_revision_count?: boolean;
}
...
export interface ClawManifestSpec {
  ...
  world_models?: (PrimitiveRef | { inline: WorldModelSpec & { name?: string } })[];
...
export type CkpPrimitive = Identity | Provider | Channel | Tool | Skill | Memory | WorldModel | Sandbox | Policy | Swarm | Telemetry;
