...
- ✓ **TV-L1-04** Initialize Happy Path (2ms)
- ✓ **TV-L1-05** Initialize Version Mismatch (1ms)
- ✓ **TV-L1-06** Status Query (3ms)
- ✓ **TV-L1-07** Shutdown Happy Path (2ms)
...
- ✓ **TV-L3-05** Role-Based Mode with Allowed IDs (Invalid Manifest) (1ms)
- ✓ **TV-L3-06** Swarm Broadcast (5000ms)
